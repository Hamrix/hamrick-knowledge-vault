...
# Frederick Ethelred Selby (1911-1992) - research lead
...
The project previously logged no reliable identity-specific search hit for Frederic/Frederick Ethelred Selby. This page supplies an exact candidate to investigate.

## What is not established

- It is not yet established that this is the same person intended by the project's "Frederic Ethelred Selby military and intelligence research" workstream.
- No military, intelligence, or service claim is established by this note.
- No relationship to Major Selby Sr., Thomas Selby Sr., or any living project line is established by this note.
- No biographical fact should be adopted until the source records linked from the profile are inspected.
...
- [ ] Search draft-registration and military/service indexes after identity is confirmed.
- [ ] Resolve place conflicts found in discovery snippets: Louisiana, New Orleans/Orleans Parish, Gulfport, Mandeville, and St. Tammany Parish.
